...
@Component({
  selector: 'app-production-white-chatni',
  templateUrl: 'production-white-chatni.page.html',
  styleUrls: ['production-white-chatni.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ProductionWhiteChatniPage implements OnInit {
  qty: number = 0;
  rate: number = 0;
  amount: number = 0;
