...
@Component({
  selector: 'app-production-samosa',
  templateUrl: 'production-samosa.page.html',
  styleUrls: ['production-samosa.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ProductionSamosaPage implements OnInit {
  qty: number = 0;
  rate: number = 0;
  amount: number = 0;
