...
@Component({
  selector: 'app-production-menduwada',
  templateUrl: 'production-menduwada.page.html',
  styleUrls: ['production-menduwada.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ProductionMenduwadaPage implements OnInit {
  qty: number = 0;
  rate: number = 0;
  amount: number = 0;
