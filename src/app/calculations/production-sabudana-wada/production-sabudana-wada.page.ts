...
@Component({
  selector: 'app-production-sabudana-wada',
  templateUrl: 'production-sabudana-wada.page.html',
  styleUrls: ['production-sabudana-wada.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ProductionSabudanaWadaPage implements OnInit {
  qty: number = 0;
  rate: number = 0;
  amount: number = 0;
