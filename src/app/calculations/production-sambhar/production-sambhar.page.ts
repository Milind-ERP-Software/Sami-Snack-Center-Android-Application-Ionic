...
@Component({
  selector: 'app-production-sambhar',
  templateUrl: 'production-sambhar.page.html',
  styleUrls: ['production-sambhar.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ProductionSambharPage implements OnInit {
  qty: number = 0;
  rate: number = 0;
  amount: number = 0;
