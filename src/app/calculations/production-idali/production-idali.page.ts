...
@Component({
  selector: 'app-production-idali',
  templateUrl: 'production-idali.page.html',
  styleUrls: ['production-idali.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ProductionIdaliPage implements OnInit {
  qty: number = 0;
  rate: number = 0;
  amount: number = 0;
