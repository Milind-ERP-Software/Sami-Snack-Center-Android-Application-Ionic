...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonIcon, IonButton, IonInput, IonItem, IonList } from '@ionic/angular/standalone';
import { AlertController, ToastController } from '@ionic/angular';
import { addIcons } from 'ionicons';
import { arrowBack, add, create, trash, checkmark, close, documentText } from 'ionicons/icons';
...
export class PurchaseItemsPage implements OnInit {
  ...
  constructor(
    ...
    addIcons({ arrowBack, add, create, trash, checkmark, close, documentText });
  }
